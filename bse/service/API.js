    ...
    transformResponse: [
      function (data) {
        ...
        if (_.size(values) >= "11") {
          ...
          return {
            symbol: values["Indx_Cd"],
            open: values["I_open"],
            high: values["High"],
            low: values["Low"],
            ltp: values["CurrValue"],
            previousClose: values["Prev_Close"],
            pointChange: values["Chg"],
            percChange: values["ChgPer"],
            timeVal: values["DT_TM"],
          };
        } else {
          return {};
        }
